...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            ...
            <!-- we gonna use the named url
                and make a route for that
            -->
          <a class="nav-link" href="{{route('write.post')}}">Create Post </a>
          </li>
          <li class="nav-item">
  ...
  <!-- here we ad a toster messgae for the notification

    // we willl write a notification with if statement
